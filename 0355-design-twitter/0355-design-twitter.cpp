...
public:
    ...
    // This Data Structure will store list of twitter users and corresponding to
    // each user there will be a set consiting of userid whom the user follow;
    vector<pair<int, int>> posts;
    // this vector will store the list of posts ::each post will have a tweetId
    // and the userId of the user Who posted it
    Twitter() {}
    ...
    vector<int> getNewsFeed(int userId) {
        // If current user tries to retrieve 10 most recent post then he will be
        // able to retrieve the posts that he himself posted or the post posted
        // by another user whom current user follow
        vector<int> ans;
